...
//construtor
Imovel::Imovel(std::string nome, int posicao, std::string path, int valor_hipoteca, int valor_compra, int proprietario) :
    CasasNegociaveis(nome, posicao, path, valor_hipoteca, valor_compra, proprietario) {}
//Destrutor
Imovel::~Imovel() {}
